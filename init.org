...
With any luck, auto-virtualenv will take care of the virtualenv issues
...
(use-package auto-virtualenv
  :ensure t
  :config
  (add-hook 'python-mode-hook 'autho-virtualenv-set-virtualenv)
...
(use-package evil
  ...
  (evil-global-set-key 'normal " xs" 'save-buffer)
  (evil-global-set-key 'normal " xf" 'counsel-find-file)
  (evil-global-set-key 'normal " xb" 'ivy-switch-buffer)
  (evil-global-set-key 'normal " xB" 'ibuffer)
  (evil-global-set-key 'normal " xk" 'kill-this-buffer)
  (evil-global-set-key 'normal " xe" 'eval-last-sexp)
