...
(use-package elfeed
  ...
  (setq
   ...
   '(("http://www.xkcd.org/atom.xml" comic)
     ...
     ("https://www.reddit.com/r/emacs/.rss" sw haskell)
...
(use-package org
  ...
  (defface org-agenda-date-beam
    `((t  :foreground ,(face-attribute 'org-priority :foreground)
...
(use-package base16-theme
  ...
  (defvar my/base16-colors base16-pop-colors)
  (base16-set-faces
   'base16-pop
   base16-pop-colors
...
(use-package general
  ...
  (general-define-key
   :states '(normal)
   :keymaps '(prog-mode-map dired-mode-map)
